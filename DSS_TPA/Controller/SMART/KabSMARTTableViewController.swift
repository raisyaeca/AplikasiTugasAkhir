//
//  KabSMARTTableViewController.swift
//  DSS_TPA
//
...
class KabSMARTTableViewController: UITableViewController {
    ...
    // MARK: - Table view data source
           ...
           override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
               performSegue(withIdentifier: "goToHasilSMART", sender: self)
           }
           
           override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
            
            if segue.identifier == "goToHasilSMART" {
            let destinationVC = segue.destination as! DataSMARTTableViewController
