//
//  KabKecTableViewController.swift
//  DSS_TPA
//
...
class KabKecTableViewController: UITableViewController {
    ...
    // MARK: - Table View Data Source
        ...
        override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
            performSegue(withIdentifier: "DataKecamatan", sender: self)
            
        }
        
        override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
            let destinationVC = segue.destination as! KecamatanDataTableViewController
